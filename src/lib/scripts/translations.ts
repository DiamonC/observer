export default {
  "en-US": {
    ...
    "settings.desc":
      "Here you can find all the settings that affect this panel, such as site URL, and trusted domains.",
  ...
  "es-ES": {
    ...
    "settings.desc":
      "Aquí puede encontrar todas las configuraciones que afectan a este sitio, como la URL del sitio y los dominios de confianza.",
    ...
    "settings.l.pb": "Pocketbase URL",
    "settings.l.max":
      "Número máximo de servidores que cada usuario puede crear",
