...
<div class="space-x-2">
{ #if state == "true" }
<a on:click={start} class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-repeat"><polyline points="17 1 21 5 17 9"></polyline><path d="M3 11V9a4 4 0 0 1 4-4h14"></path><polyline points="7 23 3 19 7 15"></polyline><path d="M21 13v2a4 4 0 0 1-4 4H3"></path></svg>{$t("button.restart2")}</a>
<a on:click={stop} class="btn btn-error"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-stop-circle"><circle cx="12" cy="12" r="10"></circle><rect x="9" y="9" width="6" height="6"></rect></svg>{$t("button.stop2")}</a>
{:else if state == "false"}
<a on:click={start} class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-play-circle"><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>{$t("button.start2")}</a>
<a href="/" class="btn btn-disabled "><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-stop-circle"><circle cx="12" cy="12" r="10"></circle><rect x="9" y="9" width="6" height="6"></rect></svg>{$t("button.stop2")}</a>
{:else}
...
<div class="space-x-7 flex justify-between p-10">
    ...
    <div>
      <div class="bg-base-300 h-96 rounded-xl shadow-xl overflow-auto w-5/6 xl:w-full">
        <p class="p-5 sm:text-xs xl:text-lg font-mono" id="terminal"></p>
      </div>
      <input on:keypress={writeCmd} id="input" type="text" placeholder="Enter Command" class="input input-secondary bg-base-200 w-5/6 xl:w-full " />
    </div>
    <div class="m-3">
